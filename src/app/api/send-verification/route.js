...
export async function POST(request) {
    ...
    try {
        ...
        const newUser = {
            ...
            country_chosen: {
                _type: 'reference',
                _ref: user?.country?._ref || '',  // Ensure _ref exists
            },
            level: {
                _type: 'reference',
                _ref: user?.study_level?._ref || '',  // Ensure _ref exists
            },
...
<body class="body" style="background-color: #f8f8f9; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
	<table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f8f8f9;">
														...
														<tr>
															<td class="pad" style="padding-bottom:25px;padding-top:22px;width:100%;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 149px;"><img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/1376/Companify-Logo.png" style="display: block; height: auto; border: 0; width: 100%;" width="149" alt="I'm an image" title="I'm an image" height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-left:10px;padding-right:10px;padding-top:15px;text-align:center;">
																<div class="alignment" align="center"><!--[if mso]>
                                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"   style="height:62px;width:218px;v-text-anchor:middle;" arcsize="97%" fillcolor="#1aa19c">
                                                                    <v:stroke dashstyle="Solid" weight="0px" color="#1aa19c"/>
                                                                    <w:anchorlock/>
													...
													<table class="image_block block-3" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="padding-top:40px;width:100%;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 149px;"><img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/1376/Logo-white.png" style="display: block; height: auto; border: 0; width: 100%;" width="149" alt="Alternate text" title="Alternate text" height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
        ...
        return NextResponse.json({ error: 'Failed to create user or send email', details: error.message }, { status: 500 });
    }
}
